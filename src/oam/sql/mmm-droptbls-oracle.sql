...
drop sequence mmm_StorageLog_SEQ;
drop table mmm_StorageLog;
...
drop sequence mmm_QueryJob_SEQ;
drop table mmm_QueryJob;


drop sequence mmm_BidReq_SEQ;
drop table mmm_BidReq;
